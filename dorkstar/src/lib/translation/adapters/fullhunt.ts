...
/**
 * FullHunt IoT/network intelligence adapter.
 * Uses `key:value` syntax.
 * Boolean syntax: uppercase AND, OR, NOT.
 */
export class FullHuntAdapter extends AbstractEngineAdapter {
  readonly engineId = 'fullhunt' as const;
  readonly displayName = 'FullHunt';
