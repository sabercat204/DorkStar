...
/**
 * LeakIX IoT/network intelligence adapter.
 * Uses `key:value` syntax.
 * Boolean syntax: uppercase AND, OR, NOT.
 */
export class LeakIXAdapter extends AbstractEngineAdapter {
  readonly engineId = 'leakix' as const;
  readonly displayName = 'LeakIX';
