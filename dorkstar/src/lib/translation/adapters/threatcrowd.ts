...
/**
 * ThreatCrowd threat intelligence adapter.
 * Uses `key:value` syntax.
 * Boolean syntax: uppercase AND, OR, NOT.
 */
export class ThreatCrowdAdapter extends AbstractEngineAdapter {
  readonly engineId = 'threatcrowd' as const;
  readonly displayName = 'ThreatCrowd';
